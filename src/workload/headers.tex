...
%\usepackage{luatexja-ruby}%nihon kanji +rubi+, maybe no longer depend on `luatexja-ruby' package, engine will be switched to XeLaTeX to speed up build process.
