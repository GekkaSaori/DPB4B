...
%\usepackage{luatexja-ruby}%nihon kanji +rubi+, **since no lyrics was included, maybe no longer depend on `luatexja-ruby'!
\usepackage[normalem]{ulem}%improved underlines, **all underlines will be changed later!**
...
\usepackage{datetime2}%build time supporting
\usepackage{yhmath}%\adots command
\usepackage{forest}%tree environment for memoSearch section
\usepackage{rotating}%rotate the tree for memoSearch section
%\usepackage{tikz}%will be test later for painting
...
% **LINES BELOW WILL BE DELETED LATER IN ORDER TO SOLVE THE ENGINE SWITCH PROBLEM:**
% **OTHER SOLUTIONS WILL BE GIVEN, MAYBE TURN TO USE SPECIAL BUILD SCRIPT TO BUILD**
% VERSION CONTROL:
